...
function (_React$Component) {
  ...
  function UserPermissions() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handlePermissionChange", function (e) {
      ...
      var updatePermissions = _toConsumableArray(_this.state.permissions); // figure out if we need to remove or add this permission
      ...
      if (checkbox.checked) {
        ...
        updatePermissions = updatePermissions.filter(function (permission) {
...
//# sourceMappingURL=permissions.js.1cbbd144d3fbcb2e603b.hot-update.js.map